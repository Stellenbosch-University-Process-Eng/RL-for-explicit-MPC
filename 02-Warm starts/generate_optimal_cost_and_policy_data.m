...
%% create matrix of coordinates (2024-02-08)
nmberLevels = 5;
...
resolution4Grid = nmberLevels;             % total number of optimisations will be resolution4Grid^nmberRLStates
...
SP_1_dimension = linspace(minimum_SP_1,maximum_SP_1,resolution4Grid);   % dimension for H1 SP
SP_2_dimension = linspace(minimum_SP_2,maximum_SP_2,resolution4Grid);   % dimension for H2 SP
H_1_dimension = linspace(minimum_H_1,maximum_H_1,resolution4Grid);      % dimension for H1 
H_2_dimension = linspace(minimum_H_2,maximum_H_2,resolution4Grid);      % dimension for H2
H_3_dimension = linspace(minimum_H_3,maximum_H_3,resolution4Grid);      % dimension for H3
H_4_dimension = linspace(minimum_H_4,maximum_H_4,resolution4Grid);      % dimension for H4
...
size_vec = resolution4Grid.*ones(1,nmberRLStates);
...
data_gamma_001_numlevels_5.SP_1_grid = SP_1_grid;
data_gamma_001_numlevels_5.SP_2_grid = SP_2_grid;
data_gamma_001_numlevels_5.H_1_grid = H_1_grid;
data_gamma_001_numlevels_5.H_2_grid = H_2_grid;
data_gamma_001_numlevels_5.H_3_grid = H_3_grid;
data_gamma_001_numlevels_5.H_4_grid = H_4_grid;

data_gamma_001_numlevels_5.u_opt_one = u_opt_one;
data_gamma_001_numlevels_5.u_opt_two = u_opt_two;
data_gamma_001_numlevels_5.optimalCosts = optimalCosts;

data_gamma_001_numlevels_5.model_parameters = param;

data_gamma_001_numlevels_5.nmberLevels = nmberLevels;

data_gamma_001_numlevels_5.Prediction_horizon = nlobj.PredictionHorizon;
data_gamma_001_numlevels_5.ControlHorizon = nlobj.ControlHorizon;

% % save data
% filename = '/scratch3/20068530/data_gamma_001_numlevels_5.mat';
% save(filename,'data_gamma_001_numlevels_5',"-v7.3");
