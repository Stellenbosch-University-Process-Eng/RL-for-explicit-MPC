...
%% save results
non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1.Experience = all_scenarios_out_Experience; % save experience generated during training
non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1.Policies = all_scenarios_out_Policies;     % save policy networks generated during training
non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1.logging.model_parameters = param;          % save dynamic model's parameters
non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1.logging.seed = sim_seed;

filename = '/scratch3/20068530/non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1';
save(filename,'non_min_phase_decr_gamma_large_alphaR_ten_scen_batch_1',"-v7.3");
